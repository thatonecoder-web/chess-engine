...
class Board:
    ...
    def make_move(self, move):
        ...
        elif (  # en passant capture: diagonal move onto an empty square
    ...
    # AI/CLI-facing convenience API: the rest of the codebase talks to
    # a Board only through the methods below.

    def copy(self):
        """Independent copy: pieces are cloned, not shared, so search can
        explore a line without mutating the real game's has_moved flags."""
