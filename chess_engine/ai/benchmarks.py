"""AI performance benchmarks: nodes/second and iterative-deepening
depth reached within a fixed time budget, on a few representative
positions. Kept separate from the pytest suite (which checks
correctness, not speed) -- run_ai_benchmarks.py at the repo root calls
this to print a human-readable report."""
